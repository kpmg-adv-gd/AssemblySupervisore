sap.ui.define([
    ...
    return PropertyEditor.extend( "kpmg.custom.tile.supervisoreAssembly.supervisoreAssembly.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("kpmg.custom.tile.supervisoreAssembly.supervisoreAssembly.i18n.builder");
			this.setPluginResourceBundleName("kpmg.custom.tile.supervisoreAssembly.supervisoreAssembly.i18n.i18n");
		},
